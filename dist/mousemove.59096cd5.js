...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"script/__typescript__/mousemove.ts":[function(require,module,exports) {
"use strict";

(function () {
  var circle = document.querySelector(".mouse-move");
  /**
   *
   * @param {String} toggle
   */

  var moveCircle = function moveCircle(toggle) {
    toggle === "hide" ? circle.classList.add("mouse-move-hidden") : circle.classList.remove("mouse-move-hidden");
  };
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","script/__typescript__/mousemove.ts"], null)
//# sourceMappingURL=/mousemove.59096cd5.js.map